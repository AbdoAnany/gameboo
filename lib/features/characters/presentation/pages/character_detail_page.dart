  ...
  Widget _buildCharacterGrid() {
    ...
    return GridView.builder(
      ...
      itemBuilder: (context, index) {
        final type = characters[index];
        final isUnlocked = _unlockStatus[type] ?? false;
        final isSelected = _selectedCharacter == type;
        final character = CharacterRepository.getCharacterByType(type);
          ...
          child: AnimatedContainer(
            ...
            decoration: BoxDecoration(
              ...
              gradient: isSelected
                  ? LinearGradient(
                      colors: [
                        _getCharacterColor(type),
                        _getCharacterColor(type).withOpacity(0.7),
                      ],
                    )
                  : null,
              border: Border.all(
            ...
            child: GlassCard(
              ...
              child: Column(
                ...
                children: [
                  CircleAvatar(
                    radius: 24.r,
                    backgroundColor: _getCharacterColor(type).withOpacity(0.7),
          ...
          Expanded(
            ...
            child: ElevatedButton(
              onPressed: () {
                ...
                context.read<ProfileCubit>().selectCharacter(
                  _selectedCharacter,
                );
                Navigator.pop(context);
              },
              style: ElevatedButton.styleFrom(
                backgroundColor: _getCharacterColor(_selectedCharacter),
                elevation: 6,
                shape: RoundedRectangleBorder(
                  borderRadius: BorderRadius.circular(12.r),
                ),
